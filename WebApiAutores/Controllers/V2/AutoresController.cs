...
{
    [ApiController]
    [Route("api/v2")] //el corchete[controller] sustituye el nombre base del controlador en este caso "autores" se puede cambiar el nombre del controlador pero no es recoemndable pq los clientes del web api ambien tendria que actualizar la url
