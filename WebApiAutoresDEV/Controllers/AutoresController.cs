...
//using WebApiAutoresDEV.DTO;
using WebApiAutoresDEV.Entidades;
//using WebApiAutoresDEV.Utilidades;
...
{
    [ApiController]
    [Route("api/v1")] //el corchete[controller] sustituye el nombre base del controlador en este caso "autores" se puede cambiar el nombre del controlador pero no es recoemndable pq los clientes del web api ambien tendria que actualizar la url
   // [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Policy = "EsAdmin")]//con este filtro protegemos todo los edpoint y ningun usuario prodría acceder a las rutas
    ...
    public class AutoresController : ControllerBase
    {
       ...
       // private readonly IMapper mapper;
        ...
        public AutoresController(ApplicationDBContextcs contexts,
            //IMapper mapper, 
