    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddSwaggerGen(c =>
           {
               c.SwaggerDoc("v1", new  OpenApiInfo { Title = "CursoWebApi", Version = "v1",
                   ...
                   Description= "Mi primer web API(Autores con Libros)",
                   Contact= new OpenApiContact { Email ="nayaemes@gmail.com", Name ="Naiara Emes Castillo"},
                  
               
               });
               c.SwaggerDoc("v2", new OpenApiInfo { Title = "CursoWebApi", Version = "v2" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment  env, ILogger<Startup> logger ) {
           ...
           // app.UseMiddleware<LoguearRspuestaHTTPMiddleware>();
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CursoWebApi v1");
                c.SwaggerEndpoint("/swagger/v2/swagger.json", "CursoWebApi v2");
            });
