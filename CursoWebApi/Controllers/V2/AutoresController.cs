...
namespace CursoWebApi.Controllers.V2
{
    [ApiController]
    [Route("api/autores")]
    [CabeceraEstaPresente("x-version", "2")]
    // [Route("api/v2/autores")] //el corchete[controller] sustituye el nombre base del controlador en este caso "autores" se puede cambiar el nombre del controlador pero no es recoemndable pq los clientes del web api ambien tendria que actualizar la url
    ...
    public class AutoresController : ControllerBase
    {
        ...
        {
            var autores = await contexts.Autores.ToListAsync();
        ...
        [HttpGet("{id:int}", Name = "ObtenerAutorV2")]// con esta ruta podemos pasar 2 o mas parametros y el segundo es opcional por el signo "?" o ("{id : int}/{param2=persona}") con este le damos un valor para que no sea null
        [AllowAnonymous]
        [ServiceFilter(typeof(HATEOASAutorFiltrerAttribute))]
        ...
        [HttpGet("{nombre}", Name = "ObtenerAutoresporNombreV2")] //con esto vamos a la ruta del web api directamente con un nombre especifio
